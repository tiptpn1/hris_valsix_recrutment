...
function disableByPolaEntry(id, urut)
{
	...
	{		
		/* reset */
		$("#reqKartu"+urut).removeAttr('disabled');
		$("#reqBukuPusat"+urut).removeAttr('disabled');
		$("#reqBukuPusat"+urut).removeAttr('disabled');
		...
		$("#reqKartu"+urut).attr('disabled','disabled'); 
		$("#reqBukuPusat"+urut).attr('disabled','disabled'); 
...
function disableByPolaEntryBak(id, urut)
{
	var lasttabindex = $("#reqBukuBesar"+urut).attr("tabindex");
	if(id == 0)
	{		
