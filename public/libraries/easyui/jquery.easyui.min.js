...
$.ajax({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},type:opts.method,url:opts.url,data:_1a3,dataType:"json",success:function(data){
_1a4(data);
},error:function(){
...
$.ajax({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},type:opts.method,url:opts.href,cache:false,data:_232,dataType:"html",success:function(data){
_233(data);
},error:function(){
...
var win=_27f(_285,_286,_287);
return win;
},alertCloseJconfirm:function(_285,msg,icon,fn){
var _286="<div>"+msg+"</div>";
switch(icon){
case "error":
_286="<div class=\"messager-icon messager-error\"></div>"+_286;
...
var win=_27f(_285,_286,_287);
return win;
},alertClosePopup:function(_285,msg,icon,fn){
var _286="<div>"+msg+"</div>";
switch(icon){
case "error":
_286="<div class=\"messager-icon messager-error\"></div>"+_286;
...
alertCloseModal:function(_285,msg,icon,modalId,fn){
var _286="<div>"+msg+"</div>";
switch(icon){
case "error":
_286="<div class=\"messager-icon messager-error\"></div>"+_286;
...
var data={};
data[_447[1]]=_446;
var _448=$.ajax({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},url:_447[0],dataType:"json",data:data,async:false,cache:false,type:"get"}).responseText;
return _448=="true";
...
$.ajax({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},url:data,data:_454,dataType:"json",success:function(data){
_455(data);
},error:function(){
...
$.ajax({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},type:opts.method,url:opts.url,data:_70c,dataType:"json",success:function(data){
_70d(data);
},error:function(){
...
$.ajax({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},type:opts.method,url:opts.url,data:_832,dataType:"json",success:function(data){
_833(data);
},error:function(){
...
$.ajax({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},type:opts.method,url:opts.url,data:_8dd,dataType:"json",success:function(data){
_8de(data);
},error:function(){
