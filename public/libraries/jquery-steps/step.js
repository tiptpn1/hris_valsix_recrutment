...
function(n, t) {
    var r = t.fn,
        i, e = Object.prototype.toString.call(window.opera) == "[object Opera]",
        u = function(n) {
            var t = n.createElement("details"),
                u, i, r;
            return ("open" in t) ? (i = n.body || function() {
                var t = n.documentElement;
                return u = !0, t.insertBefore(n.createElement("body"), t.firstElementChild || t.firstChild)
            }(), t.innerHTML = "<summary>a<\/summary>b", t.style.display = "block", i.appendChild(t), r = t.offsetHeight, t.open = !0, r = r != t.offsetHeight, i.removeChild(t), u && i.parentNode.removeChild(i), r) : !1
        }(n),
        f = function(n, t, i, r) {
            var u = n.prop("open"),
                f = u && r || !u && !r;
            f ? (n.removeClass("open").prop("open", !1).triggerHandler("close.details"), t.attr("aria-expanded", !1), i.hide()) : (n.addClass("open").prop("open", !0).triggerHandler("open.details"), t.attr("aria-expanded", !0), i.show())
        };
    r.noSelect = function() {
        var n = "none";
    ...
    u ? (i = r.details = function() {
        return this.each(function() {
            var n = t(this),
                i = t("summary", n).first();
            i.attr({
                role: "button",
                "aria-expanded": n.prop("open")
            }).on("click", function() {
                var t = n.prop("open");
                i.attr("aria-expanded", !t);
                n.triggerHandler((t ? "close" : "open") + ".details")
            })
        })
    }, i.support = u) : (i = r.details = function() {
        return this.each(function() {
            var n = t(this),
                i = t("summary", n).first(),
                r = n.children(":not(summary)"),
                u = n.contents(":not(summary)");
            i.length || (i = t("<summary>").text("Details").prependTo(n));
            r.length != u.length && (u.filter(function() {
                return this.nodeType == 3 && /[^ \t\n\f\r]/.test(this.data)
            }).wrap("<span>"), r = n.children(":not(summary)"));
            n.prop("open", typeof n.attr("open") == "string");
            f(n, i, r);
            i.attr("role", "button").noSelect().prop("tabIndex", 0).on("click", function() {
                i.focus();
                f(n, i, r, !0)
            }).keyup(function(n) {
                32 != n.keyCode && (13 != n.keyCode || e) || (n.preventDefault(), i.click())
            })
        })
    }, i.support = u)
}(document, jQuery);
! function(n, t) {
    ...
    function bt(i, f, o) {
        var s = i.children(f.headerTag),
            l = i.children(f.bodyTag),
            a, v, h;
        s.length > l.length ? r(yt, "contents") : s.length < l.length && r(yt, "titles");
        a = f.startIndex;
        (o.stepCount = s.length, f.saveState && n.cookie) && (v = n.cookie(vt + e(i)), h = parseInt(v, 0), !isNaN(h) && h < o.stepCount && (a = h));
        o.currentIndex = a;
        s.each(function(r) {
            var s = n(this),
                f = l.eq(r),
                e = f.data("mode"),
                o = null == e ? u.html : c(u, /^\s*$/.test(e) || isNaN(e) ? e : parseInt(e, 0)),
                h = o === u.html || f.data("url") === t ? "" : f.data("url"),
                a = o !== u.html && "1" === f.data("loaded"),
                v = n.extend({}, pt, {
                    title: s.html(),
                    content: o === u.html ? f.html() : "",
                    contentUrl: h,
                    contentMode: o,
                    contentLoaded: a
                });
    ...
    function gt(t, i) {
        var e = y(t),
            f, r, u;
        return t.unbind(e).removeData("uid").removeData("options").removeData("state").removeData("steps").removeData("eventNamespace").find(".actions a").unbind(e), t.removeClass(i.clearFixCssClass + " vertical"), f = t.find(".content > *"), f.removeData("loaded").removeData("mode").removeData("url"), f.removeAttr("id").removeAttr("role").removeAttr("tabindex").removeAttr("class").removeAttr("style")._removeAria("labelledby")._removeAria("hidden"), t.find(".content > [data-mode='async'],.content > [data-mode='iframe']").empty(), r = n('<{0} class="{1}"><\/{0}>'.format(t.get(0).tagName, t.attr("class"))), u = t._id(), null != u && "" !== u && r._id(u), r.html(t.find(".content").html()), t.after(r), t.remove(), r
    }

    function ft(n, t) {
        var i = n.find(".steps li").eq(t.currentIndex);
        n.triggerHandler("finishing", [t.currentIndex]) ? (i.addClass("done").removeClass("error"), n.triggerHandler("finished", [t.currentIndex])) : i.addClass("error")
    }

    function y(n) {
        var t = n.data("eventNamespace");
        return null == t && (t = "." + e(n), n.data("eventNamespace", t)), t
    }

    function s(n, t) {
        var i = e(n);
        return n.find("#" + i + it + t)
    }
    ...
    function w(n, t) {
        var i = h(n);
        return (0 > t || t >= i.length) && r(rt), i[t]
    }

    function e(n) {
        var t = n.data("uid");
        return null == t && (t = n._id(), null == t && (t = "steps-uid-".concat(tt), n._id(t)), tt++, n.data("uid", t)), t
    }

    function c(n, i) {
        var u, f;
        if (at("enumType", n), at("keyOrValue", i), "string" == typeof i) return u = n[i], u === t && r("The enum key '{0}' does not exist.", i), u;
        if ("number" == typeof i) {
            for (f in n)
                if (n[f] === i) return i;
            r("Invalid enum value '{0}'.", i)
        } else r("Invalid key or value type.")
    }

    function b(n, t, i) {
        return st(n, t, i, ii(i, 1))
    }

    function k(n, t, i) {
        return st(n, t, i, dt(i, 1))
    }

    function ti(n, t, i, u) {
        if ((0 > u || u >= i.stepCount) && r(rt), !(t.forceMoveForward && u < i.currentIndex)) {
            var f = i.currentIndex;
            return n.triggerHandler("stepChanging", [i.currentIndex, u]) ? (i.currentIndex = u, nt(n, t, i), d(n, t, i, f), l(n, t, i), ot(n, t, i), ai(n, t, i, u, f, function() {
                n.triggerHandler("stepChanged", [u, f])
            })) : n.find(".steps li").eq(f).addClass("error"), !0
        }
    }
    ...
    function ri(t) {
        ...
        return this.each(function() {
            ...
            ci(t, i, r);
            oi(t, i);
            i.autoFocus && 0 === tt && s(t, i.startIndex).focus();
            t.triggerHandler("init", [i.startIndex])
        })
    }

    function et(t, i, f, e, o) {
        (0 > e || e > f.stepCount) && r(rt);
        o = n.extend({}, pt, o);
        ui(t, e, o);
        f.currentIndex !== f.stepCount && f.currentIndex >= e && (f.currentIndex++, nt(t, i, f));
        f.stepCount++;
        var c = t.find(".content"),
            h = n("<{0}>{1}<\/{0}>".format(i.headerTag, o.title)),
            s = n("<{0}><\/{0}>".format(i.bodyTag));
        return (null == o.contentMode || o.contentMode === u.html) && s.html(o.content), 0 === e ? c.prepend(s).prepend(h) : p(t, e - 1).after(s).after(h), ct(t, f, s, e), lt(t, i, f, h, e), ht(t, i, f, e), e === f.currentIndex && d(t, i, f), l(t, i, f), t
    }
    ...
    function fi(t) {
        var r = n(this),
            ...
            o = i(r),
            e;
        if (u.suppressPaginationOnFocus && r.find(":focus").is(":input")) return t.preventDefault(), !1;
        e = {
            left: 37,
            right: 39
        };
        t.keyCode === e.left ? (t.preventDefault(), k(r, u, o)) : t.keyCode === e.right && (t.preventDefault(), b(r, u, o))
    }

    function ot(t, i, r) {
        var e, f, o;
        if (r.stepCount > 0 && (e = r.currentIndex, f = w(t, e), !i.enableContentCache || !f.contentLoaded)) switch (c(u, f.contentMode)) {
            case u.iframe:
                t.find(".content > .body").eq(r.currentIndex).empty().html('<iframe src="' + f.contentUrl + '" frameborder="0" scrolling="no" />').data("loaded", "1");
                break;
            case u.async:
                o = p(t, e)._aria("busy", "true").empty().append(g(i.loadingTemplate, {
                    text: i.labels.loading
                }));
                n.ajax({
                    url: f.contentUrl,
                    cache: !1
                }).done(function(n) {
                    o.empty().html(n)._aria("busy", "false").data("loaded", "1");
                    t.triggerHandler("contentLoaded", [e])
                })
        }
    }

    function st(n, t, i, r) {
        var e = i.currentIndex;
        if (r >= 0 && r < i.stepCount && !(t.forceMoveForward && r < i.currentIndex)) {
            var f = s(n, r),
                u = f.parent(),
                o = u.hasClass("disabled");
            return u._enableAria(), f.click(), e === i.currentIndex && o ? (u._enableAria(!1), !1) : !0
        }
        return !1
    }
    ...
    function ei(t) {
        t.preventDefault();
        var e = n(this),
            r = e.parent().parent().parent().parent(),
            o = f(r),
            u = i(r),
            s = e.attr("href");
    ...
    function l(n, t, i) {
        var r, u, f;
        t.enablePagination && (r = n.find(".actions a[href$='#finish']").parent(), u = n.find(".actions a[href$='#next']").parent(), t.forceMoveForward || (f = n.find(".actions a[href$='#previous']").parent(), f._enableAria(i.currentIndex > 0)), t.enableFinishButton && t.showFinishButtonAlways ? (r._enableAria(i.stepCount > 0), u._enableAria(i.stepCount > 1 && i.stepCount > i.currentIndex + 1)) : (r._showAria(t.enableFinishButton && i.stepCount === i.currentIndex + 1), u._showAria(0 === i.stepCount || i.stepCount > i.currentIndex + 1)._enableAria(i.stepCount > i.currentIndex + 1 || !t.enableFinishButton)))
    }

    function d(t, i, r, u) {
        var e = s(t, r.currentIndex),
            o = n('<span class="current-info audible">' + i.labels.current + " <\/span>"),
            h = t.find(".content > .title"),
            f;
        null != u && (f = s(t, u), f.parent().addClass("done").removeClass("error")._selectAria(!1), h.eq(u).removeClass("current").next(".body").removeClass("current"), o = f.find(".current-info"), e.focus());
        e.prepend(o).parent()._selectAria().removeClass("done")._enableAria();
        h.eq(r.currentIndex).addClass("current").next(".body").addClass("current")
    }

    function ht(n, t, i, r) {
        for (var f = e(n), u = r; u < i.stepCount; u++) {
            var h = f + it + u,
                s = f + a + u,
                o = f + v + u,
                c = n.find(".title").eq(u)._id(o);
            n.find(".steps a").eq(u)._id(h)._aria("controls", s).attr("href", "#" + o).html(g(t.titleTemplate, {
                index: u + 1,
                title: c.html()
            }));
            n.find(".body").eq(u)._id(s)._aria("labelledby", o)
        }
    }

    function oi(n, t) {
        var i = y(n);
        n.bind("canceled" + i, t.onCanceled);
        n.bind("contentLoaded" + i, t.onContentLoaded);
        n.bind("finishing" + i, t.onFinishing);
        n.bind("finished" + i, t.onFinished);
        n.bind("init" + i, t.onInit);
        n.bind("stepChanging" + i, t.onStepChanging);
        n.bind("stepChanged" + i, t.onStepChanged);
        t.enableKeyNavigation && n.bind("keyup" + i, fi);
        n.find(".actions a").bind("click" + i, ei)
    }

    function si(n, t, i, r) {
        return 0 > r || r >= i.stepCount || i.currentIndex === r ? !1 : (hi(n, r), i.currentIndex > r && (i.currentIndex--, nt(n, t, i)), i.stepCount--, ni(n, r).remove(), p(n, r).remove(), s(n, r).parent().remove(), 0 === r && n.find(".steps li").first().addClass("first"), r === i.stepCount && n.find(".steps li").eq(r).addClass("last"), ht(n, t, i, r), l(n, t, i), !0)
    }
    ...
    function ci(t, i, r) {
        var f = '<{0} class="{1}">{2}<\/{0}>',
            e = c(ut, i.stepsOrientation),
            o = e === ut.vertical ? " vertical" : "",
            u = n(f.format(i.contentContainerTag, "content " + i.clearFixCssClass, t.html())),
            s = n(f.format(i.stepsContainerTag, "steps " + i.clearFixCssClass, '<ul role="tablist"><\/ul>')),
            h = u.children(i.headerTag),
            l = u.children(i.bodyTag);
        t.attr("role", "application").empty().append(s).append(u).addClass(i.cssClass + " " + i.clearFixCssClass + o);
        l.each(function(i) {
            ct(t, r, n(this), i)
        });
        h.each(function(u) {
    ...
    function ct(n, t, i, r) {
        var u = e(n),
            f = u + a + r,
            o = u + v + r;
        i._id(f).attr("role", "tabpanel")._aria("labelledby", o).addClass("body")._showAria(t.currentIndex === r)
    }

    function li(n, t, i) {
        if (t.enablePagination) {
            var u = '<li><a href="#{0}" role="menuitem">{1}<\/a><\/li>',
                r = "";
            t.forceMoveForward || (r += u.format("previous", t.labels.previous));
            r += u.format("next", t.labels.next);
            t.enableFinishButton && (r += u.format("finish", t.labels.finish));
            t.enableCancelButton && (r += u.format("cancel", t.labels.cancel));
            n.append('<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}<\/ul><\/{0}>'.format(t.actionContainerTag, t.clearFixCssClass, t.labels.pagination, r));
            l(n, t, i);
            ot(n, t, i)
        }
    }
    ...
    function g(n, i) {
        for (var f, e, o = n.match(/#([a-z]*)#/gi), u = 0; u < o.length; u++) f = o[u], e = f.substring(1, f.length - 1), i[e] === t && r("The key '{0}' does not exist in the substitute collection!", e), n = n.replace(f, i[e]);
        return n
    }
    ...
    function lt(t, i, r, u, f) {
        var h = e(t),
            ...
            o = n('<li role="tab"><a id="' + l + '" href="#' + c + '" aria-controls="' + p + '">' + w + "<\/a><\/li>");
        o._enableAria(i.enableAllSteps || r.currentIndex > f);
        r.currentIndex > f && o.addClass("done");
        u._id(c).attr("tabindex", "-1").addClass("title");
        0 === f ? s.prepend(o) : s.find("li").eq(f - 1).after(o);
        0 === f && s.find("li").removeClass("first").eq(f).addClass("first");
        f === r.stepCount - 1 && s.find("li").removeClass("last").eq(f).addClass("last");
        o.children("a").bind("click" + y(t), vi)
    }

    function nt(t, i, r) {
        i.saveState && n.cookie && n.cookie(vt + e(t), r.currentIndex)
    }

    function ai(t, r, u, f, e, s) {
        var p = t.find(".content > .body"),
            v = c(o, r.transitionEffect),
        ...
        switch (v) {
            case o.fade:
            case o.slide:
                w = v === o.fade ? "fadeOut" : "slideUp";
                b = v === o.fade ? "fadeIn" : "slideDown";
                u.transitionElement = y;
                l[w](h, function() {
                    var r = n(this)._showAria(!1).parent().parent(),
                        t = i(r);
                    t.transitionElement && (t.transitionElement[b](h, function() {
                        n(this)._showAria()
            ...
            case o.slideLeft:
                ...
                n.when(l.animate({
                    ...
                    n(this)._showAria(!1)
                }), y.css("left", d + "px")._showAria().animate({
                    left: 0
                }, h)).done(s);
                break;
            default:
                n.when(l._showAria(!1), y._showAria()).done(s)
        }
    }
    ...
    function vi(t) {
        ...
        t.preventDefault();
        var u = n(this),
            r = u.parent().parent().parent().parent(),
            l = f(r),
            e = i(r),
            h = e.currentIndex;
        return u.parent().is(":not(.disabled):not(.current)") && (o = u.attr("href"), c = parseInt(o.substring(o.lastIndexOf("-") + 1), 0), ti(r, l, e, c)), h === e.currentIndex ? (s(r, h).focus(), !1) : void 0
    }

    function r(n) {
        throw arguments.length > 1 && (n = n.format(Array.prototype.slice.call(arguments, 1))), new Error(n);
    }

    function at(n, t) {
        null == t && r("The argument '{0}' is null or undefined.", n)
    }
    n.fn.extend({
        _aria: function(n, t) {
            return this.attr("aria-" + n, t)
        },
        _removeAria: function(n) {
            return this.removeAttr("aria-" + n)
        },
        _enableAria: function(n) {
            return null == n || n ? this.removeClass("disabled")._aria("disabled", "false") : this.addClass("disabled")._aria("disabled", "true")
        },
        _showAria: function(n) {
            return null == n || n ? this.show()._aria("hidden", "false") : this.hide()._aria("hidden", "true")
        },
        _selectAria: function(n) {
            return null == n || n ? this.addClass("current")._aria("selected", "true") : this.removeClass("current")._aria("selected", "false")
        },
        _id: function(n) {
            return n ? this.attr("id", n) : this.attr("id")
        }
    });
    String.prototype.format || (String.prototype.format = function() {
        for (var u, r = 1 === arguments.length && n.isArray(arguments[0]) ? arguments[0] : arguments, i = this, t = 0; t < r.length; t++) u = new RegExp("\\{" + t + "\\}", "gm"), i = i.replace(u, r[t]);
        return i
    });
    var tt = 0,
        vt = "jQu3ry_5teps_St@te_",
        it = "-t-",
        a = "-p-",
        v = "-h-",
        rt = "Index out of range.",
        yt = "One or more corresponding step {0} are missing.";
    n.fn.steps = function(t) {
        return n.fn.steps[t] ? n.fn.steps[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void n.error("Method " + t + " does not exist on jQuery.steps") : ri.apply(this, arguments)
    };
    n.fn.steps.add = function(n) {
        var t = i(this);
        return et(this, f(this), t, t.stepCount, n)
    };
    n.fn.steps.destroy = function() {
        return gt(this, f(this))
    };
    n.fn.steps.finish = function() {
        ft(this, i(this))
    };
    n.fn.steps.getCurrentIndex = function() {
        return i(this).currentIndex
    };
    n.fn.steps.getCurrentStep = function() {
        return w(this, i(this).currentIndex)
    };
    n.fn.steps.getStep = function(n) {
        return w(this, n)
    };
    n.fn.steps.insert = function(n, t) {
        return et(this, f(this), i(this), n, t)
    };
    n.fn.steps.next = function() {
        return b(this, f(this), i(this))
    };
    n.fn.steps.previous = function() {
        return k(this, f(this), i(this))
    };
    n.fn.steps.remove = function(n) {
        return si(this, f(this), i(this), n)
    };
    n.fn.steps.setStep = function() {
        throw new Error("Not yet implemented!");
    };
    n.fn.steps.skip = function() {
        throw new Error("Not yet implemented!");
    };
    var u = n.fn.steps.contentMode = {
            html: 0,
            iframe: 1,
            async: 2
        },
        ut = n.fn.steps.stepsOrientation = {
            horizontal: 0,
            vertical: 1
        },
        o = n.fn.steps.transitionEffect = {
            none: 0,
            fade: 1,
            slide: 2,
            slideLeft: 3
        },
        pt = n.fn.steps.stepModel = {
            title: "",
            content: "",
            contentUrl: "",
            contentMode: u.html,
        ...
        yi = n.fn.steps.defaults = {
            ...
            stepsOrientation: ut.horizontal,
    ...
    window.PR_SHOULD_USE_CONTINUATION = !0,
        function() {
            function d(n) {
                ...
                function h(n) {
                    var u = n.substring(1, n.length - 1).match(/\\u[\dA-Fa-f]{4}|\\x[\dA-Fa-f]{2}|\\[0-3][0-7]{0,2}|\\[0-7]{1,2}|\\[\S\s]|[^\\]/g),
                        n = [],
                        i = u[0] === "^",
                        s = ["["],
                        f, t, o;
                    for (i && s.push("^"), i = i ? 1 : 0, f = u.length; i < f; ++i) t = u[i], /\\[bdsw]/i.test(t) ? s.push(t) : (t = e(t), i + 2 < f && "-" === u[i + 1] ? (o = e(u[i + 2]), i += 2) : o = t, n.push([t, o]), o < 65 || t > 122 || (o < 65 || t > 90 || n.push([Math.max(65, t) | 32, Math.min(o, 90) | 32]), o < 97 || t > 122 || n.push([Math.max(97, t) & -33, Math.min(o, 122) & -33])));
                    for (n.sort(function(n, t) {
                            return n[0] - t[0] || t[1] - n[1]
                        }), u = [], f = [], i = 0; i < n.length; ++i) t = n[i], t[0] <= f[1] + 1 ? f[1] = Math.max(f[1], t[1]) : u.push(f = t);
                    for (i = 0; i < u.length; ++i) t = u[i], s.push(r(t[0])), t[1] > t[0] && (t[1] + 1 > t[0] && s.push("-"), s.push(r(t[1])));
                    return s.push("]"), s.join("")
                }

                function c(n) {
                    for (var i, u = n.source.match(/\[(?:[^\\\]]|\\[\S\s])*]|\\u[\dA-Fa-f]{4}|\\x[\dA-Fa-f]{2}|\\\d+|\\[^\dux]|\(\?[!:=]|[()^]|[^()[\\^]+/g), s = u.length, f = [], t = 0, e = 0; t < s; ++t) i = u[t], i === "(" ? ++e : "\\" === i.charAt(0) && (i = +i.substring(1)) && (i <= e ? f[i] = -1 : u[t] = r(i));
                    for (t = 1; t < f.length; ++t) - 1 === f[t] && (f[t] = ++l);
                    for (e = t = 0; t < s; ++t) i = u[t], i === "(" ? (++e, f[e] || (u[t] = "(?:")) : "\\" === i.charAt(0) && (i = +i.substring(1)) && i <= e && (u[t] = "\\" + f[i]);
                    for (t = 0; t < s; ++t) "^" === u[t] && "^" !== u[t + 1] && (u[t] = "");
                    if (n.ignoreCase && o)
                        for (t = 0; t < s; ++t) i = u[t], n = i.charAt(0), i.length >= 2 && n === "[" ? u[t] = h(i) : n !== "\\" && (u[t] = i.replace(/[A-Za-z]/g, function(n) {
                            return n = n.charCodeAt(0), "[" + String.fromCharCode(n & -33, n | 32) + "]"
                        }));
                    return u.join("")
                }
                for (var t, l = 0, o = !1, u = !1, i = 0, f = n.length; i < f; ++i)
                    if (t = n[i], t.ignoreCase) u = !0;
                ...
                function e(n) {
                    ...
                    if (s == 1) {
                        if (!o.test(n.className)) {
                            for (s = n.firstChild; s; s = s.nextSibling) e(s);
                            s = n.nodeName.toLowerCase();
                            ("br" === s || "li" === s) && (u[i] = "\n", r[i << 1] = f++, r[i++ << 1 | 1] = n)
                        }
                    } else(s == 3 || s == 4) && (s = n.nodeValue, s.length && (s = t ? s.replace(/\r\n?/g, "\n") : s.replace(/[\t\n\r ]+/g, " "), u[i] = s, r[i << 1] = f, f += s.length, r[i++ << 1 | 1] = n))
                }
                var o = /(?:^|\s)nocode(?:\s|$)/,
                    u = [],
                    f = 0,
            ...
            function s(n, t, i, r) {
                t && (n = {
                    a: t,
                    e: n
                }, i(n), r.push.apply(r, n.g))
            }

            function nt(n) {
                for (var r, t = void 0, i = n.firstChild; i; i = i.nextSibling) r = i.nodeType, t = r === 1 ? t ? n : i : r === 3 ? it.test(i.nodeValue) ? n : t : t;
                if (t !== n) return t
            }
            ...
            function u(t, i) {
                function r(n) {
                    for (var h, p, w, v = n.e, y = [v, "pln"], k = 0, d = n.a.match(f) || [], g = {}, b = 0, nt = d.length; b < nt; ++b) {
                        var l = d[b],
                            ...
                            a = void 0,
                            t;
                        if (typeof o == "string") t = !1;
                        else {
                            if (h = u[l.charAt(0)], h) a = l.match(h[1]), o = h[0];
                            else {
                                for (t = 0; t < e; ++t)
                ...
                return function() {
                    for (var r, e, h, c = t.concat(i), o = [], l = {}, s = 0, a = c.length; s < a; ++s) {
                        if (r = c[s], e = r[3], e)
                            for (h = e.length; --h >= 0;) u[e.charAt(h)] = r;
                        r = r[1];
                        e = "" + r;
            ...
            function h(n, t, i) {
                function s(n) {
                    var t = n.nodeType,
                        r, u;
                    if (t != 1 || c.test(n.className))(t == 3 || t == 4) && i && (r = n.nodeValue, u = r.match(l), u && (t = r.substring(0, u.index), n.nodeValue = t, (r = r.substring(u.index + u[0].length)) && n.parentNode.insertBefore(e.createTextNode(r), n.nextSibling), h(n), t || n.parentNode.removeChild(n)));
                    else if ("br" === n.nodeName) h(n), n.parentNode && n.parentNode.removeChild(n);
                    else
                        for (n = n.firstChild; n; n = n.nextSibling) s(n)
                }

                function h(n) {
                    function i(n, t) {
                        var e = t ? n.cloneNode(!1) : n,
                            r = n.parentNode,
                            f, u;
                        if (r)
                            for (r = i(r, 1), f = n.nextSibling, r.appendChild(e), u = f; u; u = f) f = u.nextSibling, r.appendChild(u);
                        return e
                    }
                    for (; !n.nextSibling;)
                        if (n = n.parentNode, !n) return;
                    for (var n = i(n.nextSibling, 0), t;
                        (t = n.parentNode) && t.nodeType === 1;) n = t;
                    f.push(n)
                }
                for (var f, r, o, c = /(?:^|\s)nocode(?:\s|$)/, l = /\r\n?|\n/, e = n.ownerDocument, u = e.createElement("li"); n.firstChild;) u.appendChild(n.firstChild);
                for (f = [u], r = 0; r < f.length; ++r) s(f[r]);
                t === (t | 0) && f[0].setAttribute("value", t);
                o = e.createElement("ol");
                o.className = "linenums";
                for (var t = Math.max(0, t - 1 | 0) || 0, r = 0, a = f.length; r < a; ++r) u = f[r], u.className = "L" + (r + t) % 10, u.firstChild || u.appendChild(e.createTextNode(" ")), o.appendChild(u);
                n.appendChild(o)
            }

            function t(n, t) {
                for (var i, r = t.length; --r >= 0;) i = t[r], o.hasOwnProperty(i) ? f.console && console.warn("cannot override language handler %s", i) : o[i] = n
            }
            ...
            function l(n) {
                ...
                try {
                    ...
                    var v = /\bMSIE\s(\d+)/.exec(navigator.userAgent),
                        ...
                        l = t.length,
                        nt = 0;
                    for (t[l] = d, i = e = 0; i < l;) t[i] !== t[i + 2] ? (t[e++] = t[i++], t[e++] = t[i++]) : i += 2;
                    for (l = e, i = e = 0; i < l;) {
                        for (var st = t[i], ut = t[i + 1], o = i + 2; o + 2 <= l && t[o + 1] === ut;) o += 2;
                        t[e++] = st;
                        t[e++] = ut;
                        i = o
                    }
            ...
            var f = window,
                ...
                a = [e, "alignof,align_union,asm,axiom,bool,concept,concept_map,const_cast,constexpr,decltype,delegate,dynamic_cast,explicit,export,friend,generic,late_check,mutable,namespace,nullptr,property,reinterpret_cast,static_assert,static_cast,template,typeid,typename,using,virtual,where"],
                v = [e, "abstract,assert,boolean,byte,extends,final,finally,implements,import,instanceof,interface,null,native,package,strictfp,super,synchronized,throws,transient"],
                y = [v, "as,base,by,checked,decimal,delegate,descending,dynamic,event,fixed,foreach,from,group,implicit,in,internal,into,is,let,lock,object,out,override,orderby,params,partial,readonly,ref,sbyte,sealed,stackalloc,string,select,uint,ulong,unchecked,unsafe,ushort,var,virtual,where"],
                e = [e, "debugger,eval,export,function,get,null,set,undefined,var,with,Infinity,NaN"],
                p = [r, "and,as,assert,class,def,del,elif,except,exec,finally,from,global,import,in,is,lambda,nonlocal,not,or,pass,print,raise,try,with,yield,False,True,None"],
                w = [r, "alias,and,begin,case,class,def,defined,elsif,end,ensure,false,in,module,next,nil,not,or,redo,rescue,retry,self,super,then,true,undef,unless,until,when,yield,BEGIN,END"],
                tt = [r, "as,assert,const,copy,drop,enum,extern,fail,false,fn,impl,let,log,loop,match,mod,move,mut,priv,pub,pure,ref,self,static,struct,true,trait,type,unsafe,use"],
                ...
                it = /\S/,
                rt = i({
                    keywords: [a, y, e, "caller,delete,die,do,dump,elsif,eval,exit,foreach,for,goto,if,import,last,local,my,next,no,our,print,package,redo,require,sub,undef,unless,until,use,wantarray,while,BEGIN,END", p, w, r],
                    hashComments: !0,
                    cStyleComments: !0,
                    multiLineStrings: !0,
                    regexLiterals: !0
            ...
            k = f.PR = {
                ...
                PR_TAG: "tag",
                PR_TYPE: "typ",
                prettyPrintOne: f.prettyPrintOne = function(n, t, i) {
                    var r = document.createElement("div");
                    return r.innerHTML = "<pre>" + n + "<\/pre>", r = r.firstChild, i && h(r, i, !0), l({
                        h: t,
                        j: i,
                        c: r,
                        i: 1
                ...
                prettyPrint: f.prettyPrint = function(t, i) {
                    function a() {
                        for (var i, r, ut, ft = f.PR_SHOULD_USE_CONTINUATION ? u.now() + 250 : Infinity; c < e.length && u.now() < ft; c++) {
                            for (var s = e[c], rt = b, v = s; v = v.previousSibling;) {
                                if (r = v.nodeType, i = (r === 7 || r === 8) && v.nodeValue, i ? !/^\??prettify\b/.test(i) : r !== 3 || /\S/.test(v.nodeValue)) break;
                                if (i) {
                                    rt = {};
                            ...
                            if (v = s.className, (rt !== b || w.test(v)) && !d.test(v)) {
                                for (r = !1, i = s.parentNode; i; i = i.parentNode)
                                    ...
                                    if (s.className += " prettyprinted", r = rt.lang, r || (r = v.match(p), !r && (ut = nt(s)) && tt.test(ut.tagName) && (r = ut.className.match(p)), r && (r = r[1])), g.test(s.tagName)) i = 1;
                                    else var i = s.currentStyle,
                                        o = k.defaultView,
                                        i = (i = i ? i.whiteSpace : o && o.getComputedStyle ? o.getComputedStyle(s, n).getPropertyValue("white-space") : 0) && "pre" === i.substring(0, 3);
                                    o = rt.linenums;
                    ...
                    for (var s, v, u, r = i || document.body, k = r.ownerDocument || document, r = [r.getElementsByTagName("pre"), r.getElementsByTagName("code"), r.getElementsByTagName("xmp")], e = [], o = 0; o < r.length; ++o)
                        for (s = 0, v = r[o].length; s < v; ++s) e.push(r[o][s]);
                    r = n;
                    u = Date;
                    u.now || (u = {
                        now: function() {
...
$(function() {
    var t = /\.(zip|exe|pdf|doc*|xls*|ppt*|mp3|js|md)$/i,
        n = "";
    $("base").attr("href") != undefined && (n = $("base").attr("href"));
    $("a").each(function() {
        var i = $(this).attr("href");
        i && i.match(/^https?\:/i) && !i.match(document.domain) ? $(this).click(function() {
            return ga("send", "event", "External", "Click", i.replace(/^https?\:\/\//i, "")), $(this).attr("target") != null && $(this).attr("target").toLowerCase() !== "_blank" ? (setTimeout(function() {
                location.href = i
            }, 200), !1) : void 0
        }) : i && i.match(/^mailto\:/i) ? $(this).click(function() {
            ga("send", "event", "Email", "Click", i.replace(/^mailto\:/i, ""))
        }) : i && i.match(t) && $(this).click(function() {
            return ga("send", "event", "Download", "Click", i), $(this).attr("target") != null && $(this).attr("target").toLowerCase() !== "_blank" ? (setTimeout(function() {
                location.href = n + i
            }, 200), !1) : void 0
        })
    })
