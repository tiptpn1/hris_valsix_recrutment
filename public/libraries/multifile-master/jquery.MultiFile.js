...
if (window.jQuery)(function ($) {
	...
	*/
	$.fn.MultiFile.options = { //$.extend($.fn.MultiFile, { options: {
		...
		STRING: {
			remove: 'x',
			denied: 'Ekstensi $ext anda tidak sesuai.\nSilahkan pilih ulang.',
			file: '$file',
			selected: 'File selected: $file',
			duplicate: 'File sudah anda pilih sebelumnya :\n$file',
			toomuch: 'Ukuran file anda terlalu besar ($size)',
			toomany: 'Maksimal file yang dapat anda upload adalah $max file.',
			toobig: '$file terlalu besar (maksimal $size)'
		},
