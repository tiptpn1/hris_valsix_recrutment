...
//	var $numTagOpen		= '&nbsp;';
	...
	function createSearching2Crfs(){
		
        $this->additionalParam = "{'page' : 0, 'content' : '".$this->contentDiv."', 'show' : ".$this->showRecord.", 'search' : $('#".$this->searchVarible."').val(), 'search2' : $('#".$this->searchVarible2."').val(), 'searchCrfs' : '".$this->searchCrfs."', 'array_serialized' : '".$this->arrSerialized."' }";
	...
	function getAJAXlink( $count, $text) {
        ...
        $this->additionalParam = "{'page' : $pageCount, 'content' : '".$this->contentDiv."', 'show' : ".$this->showRecord.", 'search' : '".$this->searchText."', 'search2' : '".$this->searchText2."', 'searchCrfs' : '".$this->searchCrfs."', 'array_serialized' : '".$this->arrSerialized."' }";
		
		/*if( $this->contentTopDiv == '')
		{
		...
		{*/
			return "<a href=\"javascript:void(0);\" " . $this->anchorClass . "
				onclick=\"$.post('". $this->baseURL."', ". $this->additionalParam .", function(data){
					   $('#". $this->contentDiv . "').html(data);
					   $('html, body').animate({ scrollTop: $('#".$this->contentDiv."').offset().top - 200}, 2000);
					   }); return false;\">"
			   . $text .'</a>';
			   // $('html, body').animate({ scrollTop: $('#".$this->contentTopDiv."').offset().top}, 0);
		// }
	}
