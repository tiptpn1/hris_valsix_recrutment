...
###############################################################################
{
  return preg_replace_callback("/\{([<>])([a-zA-Z0-9_]*)(\?{0,1})([a-zA-Z0-9_]*)\}(.*)\{\\1\/\\2\}/isU",
...
# Change back the allowed entities in our entity whitelist
  ...
  $string = preg_replace('/&amp;([A-Za-z][A-Za-z0-9]{0,19});/',
                         '&\\1;', $string);
  $string = preg_replace_callback('/\{([<>])([a-zA-Z0-9_]*)(\?{0,1})([a-zA-Z0-9_]*)\}(.*)\{\\1\/\\2\}/isU',
    function($m) { return CallFunction($m[1], $m[2], $m[3], $m[4], $m[5]); }, $string);
