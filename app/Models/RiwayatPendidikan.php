...
class RiwayatPendidikan extends Entity{ 
    ...
    **/
	...
	function insertData()
	{
		...
		$this->setField("RIWAYAT_PENDIDIKAN_ID", $this->getSeqId("RIWAYAT_PENDIDIKAN_ID","RIWAYAT_PENDIDIKAN")); 
    ...
    **/ 
	...
	{
		$str = "SELECT RIWAYAT_PENDIDIKAN_ID, MD5(PELAMAR_ID) PELAMAR_ID_ENKRIP, PELAMAR_ID, PENDIDIKAN_ID,
				  SEKOLAH_ID, JURUSAN_PENDIDIKAN, NO_IJAZAH, IPK, IPK_LUAR, TAHUN_DIK_AWAL, TAHUN_DIK_AKHIR,
