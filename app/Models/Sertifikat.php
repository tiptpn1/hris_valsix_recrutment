...
class Sertifikat extends Entity{ 
    ...
    **/
	...
	function insertData()
	{
		...
		$this->setField("SERTIFIKAT_ID", $this->getSeqId("SERTIFIKAT_ID","SERTIFIKAT")); 		
    ...
    **/ 
	...
	{
		$str = "
				SELECT SERTIFIKAT_ID, KODE, NAMA, KETERANGAN, CREATED_BY, CREATED_DATE,
    ...
    **/ 
	...
	{
		$str = "SELECT COUNT(SERTIFIKAT_ID) AS ROWCOUNT FROM SERTIFIKAT A
	...
	{
		$str = "SELECT COUNT(SERTIFIKAT_ID) AS ROWCOUNT FROM SERTIFIKAT
		        WHERE SERTIFIKAT_ID IS NOT NULL ".$statement; 
		foreach ($paramsArray as $key => $val)
		{
			$str .= " AND $key LIKE '%$val%' ";
