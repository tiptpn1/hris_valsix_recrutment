...
class PelamarKaryaTulis extends Entity{ 
    ...
    **/
	...
	function insertData()
	{
		...
		$this->setField("PELAMAR_KARYA_TULIS_ID", $this->getSeqId("PELAMAR_KARYA_TULIS_ID","PELAMAR_KARYA_TULIS")); 
    ...
    **/ 
	...
	{
		$str = "SELECT PELAMAR_KARYA_TULIS_ID, MD5(PELAMAR_ID) PELAMAR_ID_ENKRIP, PELAMAR_ID, TAHUN, NAMA, TANGGAL
