...
class UsersBase extends Entity{ 
    ...
    **/
    function insertData(){
		...
		$str = "INSERT INTO user_login 
                (USER_LOGIN_ID, PELAMAR_ID, NAMA, EMAIL ,STATUS, USER_LOGIN, USER_PASS, CREATED_BY, CREATED_DATE) 
                VALUES(
    ...
    **/ 
	...
	{
      $str = "SELECT USER_LOGIN_ID, PELAMAR_ID, NAMA, EMAIL ,STATUS, USER_LOGIN, USER_PASS, CREATED_BY, CREATED_DATE FROM USER_LOGIN A WHERE 1 = 1 "; 
      foreach ($paramsArray as $key => $val){
        $str .= " AND $key = '$val' ";
      }
