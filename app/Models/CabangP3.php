    ...
    **/ 
	...
	function getCountByParamsMonitoring($paramsArray=array(), $statement="")
	{
		$str = "SELECT COUNT(1) AS ROWCOUNT 
				FROM CABANG A
				LEFT JOIN CABANG_HARI_KERJA B ON A.CABANG_ID = B.CABANG_ID AND B.KATEGORI_JABATAN = 'PS'
				LEFT JOIN CABANG_HARI_KERJA C ON A.CABANG_ID = C.CABANG_ID AND C.KATEGORI_JABATAN = 'OPS'
				WHERE 1=1 
				".$statement; 
