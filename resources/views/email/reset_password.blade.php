...
$sql = " SELECT nama, email, whatsapp, date_format(current_date, '%d%m%y') as tanggal FROM pelamar WHERE pelamar_id = '$PELAMAR_ID' ";
$rowResult = KDatabase::query2($sql)->first_row();

$TANGGAL = $rowResult->tanggal;
$PELAMAR_MD5_ID = md5($PELAMAR_ID."pelamar".$TANGGAL.config("app.md5key"));
?>
															...
															<td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
																<div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:15px;text-align:justify;">
																	<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #808389;"> 
                                                                        ...
                                                                        <p>Anda telah melakukan request perubahan password.
                                                                         Silahkan klik Tombol dibawah ini untuk melakukan perubahan password.</p>
																</div>
															</td>
														</tr>
													</table>
															...
															<td class="pad" style="padding-left:10px;padding-right:10px;text-align:center;">
																<div class="alignment" align="center">
                                                                    <span class="button" style="background-color: #1aa19c; border-bottom: 0px solid transparent; border-left: 0px solid transparent; border-radius: 60px; border-right: 0px solid transparent; border-top: 0px solid transparent; color: #ffffff; display: inline-block; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-size: 16px; font-weight: undefined; mso-border-alt: none; padding-bottom: 15px; padding-top: 15px; padding-left: 30px; padding-right: 30px; text-align: center; width: auto; word-break: keep-all; letter-spacing: normal;">
                                                                        <span style="margin: 0; word-break: break-word; line-height: 32px;"><strong><a style="color: #ffffff; " href="<?=config("app.base_publish")?>app/index/reset_password/<?=$PELAMAR_MD5_ID?>">Reset Password</a></strong></span></span>
                                                                </div>
															</td>
														</tr>
													</table>
