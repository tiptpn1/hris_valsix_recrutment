...
use App\Models\PelamarPrestasi;
use App\Models\PelamarKaryaTulis;
use App\Models\PelamarKegiatanSosial;
$this->load->libary("FileHandler");
...
//$tempLinkCssSecurity= $INDEX_SUB."/assets/valsix/WEB-INF/";
//$tempLinkSecurity= $INDEX_SUB."/";

$tempLinkCssSecurity= $INDEX_SUB."../WEB-INF/";
$tempLinkSecurity= $INDEX_SUB."../";
	...
	$(function(){
		$('#ff').form({
			...
			success:function(data){
				...
				data = data.split("-");
				$.messager.alertReload('Info', data[1], 'info');
				$('#rst_form').click();
				...
				{
				?>
				document.location.href = 'app/index/data_pribadi_upload';
				<?
				}
				else
				{
				?>
				document.location.href = 'app/index/data_pribadi_lain';
				<?
				}
				?>
