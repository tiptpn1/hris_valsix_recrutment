...
<div class="<?=($auth->userPelamarId == "") ? "col-sm-12" : "col-sm-8 col-sm-pull-4"?>">
	...
	<div id="judul-halaman">Lupa Password</div>
    <div id="data-form">
    	...
    	<form id="ff" method="post" novalidate enctype="multipart/form-data">
        	<div class="password-area">
                ...
                <div class="body">
                	<div class="alert alert-warning" role="alert">Silahkan masukkan No. NIK Anda, kami akan mengirim link reset password melalui email anda.</div>
