...
$reqRowDetilId= request()->reqRowDetilId;
...
?>
    <td colspan="4">
        ...
        <div>
            ...
            <!--<a  class="md-trigger" data-modal="modal-kirim-formasi">-->
            <?php /*?><a  class="md-trigger" data-modal="modal-10" onclick="setModal('setLookupLogin', '<?=$tempLinkSecurity?>modal/login')" >Kirim Lamaran</a><?php */?>
            <a  class="md-trigger" data-modal="modal-10" onclick="setModal('setLookupLogin', 'modal_login.php')" >Kirim Lamaran</a>
            </div>
            <?
            }
            else
            ...
            ?>
                <!-- SETELAH LOGIN -->
                <div class="kirim-lamaran"><a href="app/index/formasi_lowongan_daftar&reqRowId=<?=$tempDetilRowId?>" >Kirim Lamaran</a></div>
            <?
                }
            }
            ?>
