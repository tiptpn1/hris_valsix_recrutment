	...
	$(function(){
		...
		$('#ff').form({
			...
			success:function(data){
				$.messager.alertLink('Info', data, 'info', 'app/index/data_pribadi');
    ...
    <div id="pendaftaran">
        ...
        <table>
            ...
            <tr id="reqSimpanInfo" style="display:none">
            	<td colspan="2"><p class="keterangan">Dengan klik tombol SETUJU, Saya menyatakan telah membaca dan memahami seluruh petunjuk serta mengijinkan Panitia Rekrutmen dan Seleksi untuk menggunakan data administrasi dalam proses rekrutmen dan seleksi pegawai PTPN 1</p></td>
            </tr>
